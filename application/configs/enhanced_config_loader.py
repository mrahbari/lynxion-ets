...
class EnhancedConfigLoader:
    ...
    def _extract_broker_config_data(self) -> Dict[str, Any]:
        ...
        broker_data = {
            ...
            'paper_trading': self.env_loader.get_bool_env_var('BROKER_PAPER_TRADING', True),
    ...
    def _extract_strategy_config_data(self) -> Dict[str, Any]:
        ...
        strategy_data = {
            ...
            'min_confidence_threshold': self.env_loader.get_float_env_var('STRATEGY_MIN_CONFIDENCE_THRESHOLD', 0.3),
