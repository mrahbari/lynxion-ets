...
class MarketPulseWatcherImprovedAdapter(BaseWatcher):
    """Improved Market Pulse Watcher - detects market sentiment and momentum with more sensitivity"""

    def __init__(self, name: str, symbol: str, broker_service=None, lookback: int = 15, target_broker=None):  # Reduced for more responsive signals
        ...
        self.price_change_threshold = 0.001  # 0.1% - reduced for more sensitivity
        ...
        self.bollinger_threshold = 0.002  # Reduced for more sensitivity
