...
class TrendFollowStrategyAdapter(BaseStrategyAdapter):
    ...
    def generate_signal(self, symbol: Symbol) -> Optional[Signal]:
        ...
        logger.info(f"TrendFollow strategy generating signal for {symbol.value}")
        ...
        logger.info(f"TrendFollow generated signal: {signal.signal_type.name} with confidence {signal.confidence}")
        return signal
...
class MeanReversionStrategyAdapter(BaseStrategyAdapter):
    ...
    def generate_signal(self, symbol: Symbol) -> Optional[Signal]:
        ...
        logger.info(f"MeanReversion strategy generating signal for {symbol.value}")
        ...
        logger.info(f"MeanReversion generated signal: {signal.signal_type.name} with confidence {signal.confidence}")
        return signal
...
class ScalpingStrategyAdapter(BaseStrategyAdapter):
    ...
    def generate_signal(self, symbol: Symbol) -> Optional[Signal]:
        ...
        logger.info(f"Scalper strategy generating signal for {symbol.value}")
        ...
        logger.info(f"Scalper generated signal: {signal.signal_type.name} with confidence {signal.confidence}")
        return signal
...
class BreakoutStrategyAdapter(BaseStrategyAdapter):
    ...
    def generate_signal(self, symbol: Symbol) -> Optional[Signal]:
        ...
        logger.info(f"Breakout strategy generating signal for {symbol.value}")
        ...
        logger.info(f"Breakout generated signal: {signal.signal_type.name} with confidence {signal.confidence}")
        return signal