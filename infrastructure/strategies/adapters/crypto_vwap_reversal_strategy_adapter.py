"""
Infrastructure implementation of the Crypto VWAP Reversal Strategy following hexagonal architecture.
"""
...
class CryptoVWAPReversalStrategyAdapter(StrategyPort):
    """VWAP reversal strategy for crypto markets"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.name = "CryptoVWAPReversal"
    ...
    def generate_signal(self, symbol: Symbol) -> Optional[Signal]:
        """Generate signal using VWAP reversal analysis"""
