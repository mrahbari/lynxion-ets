...
class SweepScalperAdapter(BaseStrategyAdapter):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        from infrastructure.strategies.strategy_config import get_sweep_scalper_config
        system_config = get_sweep_scalper_config()
    ...
    def calculate_position_size(self, signal: Signal, account_balance: float) -> float:
        """Request position size - placeholder to maintain interface compatibility"""
        return 0.0
