"""
Infrastructure implementation of the Crypto OI Footprint Strategy following hexagonal architecture.
"""
...
class CryptoOIFootprintStrategyAdapter(StrategyPort):
    """Open Interest and volume footprint strategy for crypto markets"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.name = "CryptoOIFootprint"
