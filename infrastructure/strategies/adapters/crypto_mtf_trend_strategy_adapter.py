"""
Infrastructure implementation of the Crypto MTF Trend Strategy following hexagonal architecture.
"""
...
class CryptoMTFTrendStrategyAdapter(StrategyPort):
    """Multi-timeframe trend strategy for crypto markets"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.name = "CryptoMTFTrend"
    ...
    def generate_signal(self, symbol: Symbol) -> Optional[Signal]:
        """Generate signal using multi-timeframe trend analysis"""
