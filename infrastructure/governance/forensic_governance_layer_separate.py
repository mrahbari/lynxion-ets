"""
Forensic Governance Layer Module for Enterprise Hedge Fund Trading System
...
from infrastructure.statistical_validation.statistical_authority_engine import statistical_authority_engine
...
class ForensicGovernanceLayer:
    ...
    def _classify_decision_from_gate_result(self, gate_result, result_details) -> TradeClassification:
        """
