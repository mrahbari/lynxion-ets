"""Hyperopt runner following hexagonal architecture."""
...
class HyperoptRunner:
    """Runner for hyperopt optimization following hexagonal architecture."""

    def __init__(self,
                 trials_file: str = "data/hyperopt_trials.pkl",
                 best_params_file: str = "data/best_params.json",
                 strategy_name: str = "crypto_breakout"):
        self.trials_file = Path(trials_file)
        self.best_params_file = Path(best_params_file)
        self.strategy_name = strategy_name
        self.logger = EnhancedLogger("HyperoptRunner")
    ...
    def run_optimization(self,
        ...
        self.logger.info(f"Starting hyperopt optimization for strategy: {self.strategy_name}")
        ...
        try:
            ...
            self.logger.info("Hyperopt optimization completed successfully")
            return {"best_params": best, "trials_count": len(trials.trials)}

        except Exception as e:
            self.logger.error(f"Error during hyperopt optimization: {e}")
            return {"error": str(e)}
...
if __name__ == "__main__":
    # Example usage
    print("\n🚀 Initializing Hyperopt Runner...")

    # Create runner instance
    runner = HyperoptRunner(
        trials_file="data/hyperopt_trials.pkl",
