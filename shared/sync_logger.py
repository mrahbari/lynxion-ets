    ...
    def _write_log(self, log_entry: Dict[str, Any]) -> None:
        ...
        if self.log_file:
            try:
                ...
                fallback_entry["logging_error"] = str(e)
                print(json.dumps(fallback_entry), flush=True)
        else:
...
# Global logger instance — anchored to <project-root>/logs (not cwd-relative).
from shared.log_paths import log_path
logger = SyncLogger(log_file=log_path("sync.log"))