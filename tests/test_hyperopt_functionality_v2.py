...
def test_multi_objective_optimization():
    ...
    # Test that it has the multi-objective method
    assert hasattr(objective_handler, '_calculate_metrics_for_asset'), "Should have multi-objective method"
    assert hasattr(objective_handler, 'create_objective_function'), "Should have objective function creator"
...
def test_basic_imports():
    ...
    import shared.optimization_service
    import infrastructure.optimization.hyperopt_space
    import infrastructure.optimization.hyperopt_objective
    import application.risk_management.enterprise_risk_manager
    import domain.ports.optimization_ports
